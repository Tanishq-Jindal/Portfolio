          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5">
              {certificationsData.map((cert, index) => (
                <div
                  key={index}
                  className="p-4 sm:p-4.5 rounded-xl bg-slate-900/40 border border-slate-800/80 hover:border-slate-700/80 transition-all backdrop-blur-sm flex items-center justify-between gap-4 group"
                >
